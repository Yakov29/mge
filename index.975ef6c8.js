...
var _reviewsSystemJs = require("./js/reviews/reviewsSystem.js");
var _settingsJs = require("./js/settings.js");
var _coursesJs = require("./js/courses.js");

},{"./js/home.js":"cEl3V","./js/sponsors.js":"dGZZX","./js/profile/addProfile.js":"4GtSn","./js/profile/profileSystem.js":"3rbMf","./js/reviews/reviewsSystem.js":"cVZj8","./js/settings.js":"dXtqq","./js/courses.js":"dKvZw"}],"cEl3V":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (registerForm) registerForm.addEventListener("submit", async (e)=>{
        ...
        try {
            ...
            await (0, _profileSystem.addProfile)(profile);
    ...
    if (loginForm) loginForm.addEventListener("submit", async (e)=>{
        ...
        try {
            ...
            const profiles = await (0, _profileSystem.getProfiles)();
